...
static float         Q[LENGTH]  = {0.001f};//0.0001f              //  系统过程的协方差	协方差的定义：真实值与期望值之差的平方的期望值
static float         R[LENGTH]  = {1.5};              //  测量过程的协方差	协方差的定义：真实值与期望值之差的平方的期望值   
...
//0.0001 1没有延迟
//0.001  1.5 有小延迟,但可以滤掉部分视觉延迟带来的超调
