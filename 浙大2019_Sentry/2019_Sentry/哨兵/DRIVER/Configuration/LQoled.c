...
const u8 F14x16[] = {
    ...
    0x08,0x09,0x45,0x41,0x3F,0x00,0x1F,0x09,0x09,0x4F,0x40,0x7F,0x00,0x00,//?1
    0x20,0x38,0xA6,0x60,0x18,0x20,0xD0,0x4E,0x48,0xC8,0x68,0x58,0xC0,0x00,
    0x22,0x23,0x22,0x12,0x12,0x00,0x3F,0x44,0x44,0x47,0x44,0x44,0x77,0x00,//?2
    0x40,0x20,0x10,0x0C,0x00,0x00,0x7E,0x00,0x00,0x04,0x08,0x10,0x60,0x00,
    0x40,0x44,0x44,0x44,0x44,0x44,0x7F,0x44,0x44,0x44,0x44,0x44,0x40,0x00,//?3
};
...
void LCD_Show_Number (u8 X,u8 Y,int num)
{
    if(num<0)
    {   LCD_write_char(X*6,Y,'-');
        num=-num;
    }
    else
        LCD_write_char(X*6,Y,(num/10000)%10);

    LCD_write_char((X+1)*6,Y, (num/1000)%10);
    LCD_write_char((X+2)*6,Y, (num/100)%10);
    LCD_write_char((X+3)*6,Y, (num/10)%10);
    LCD_write_char((X+4)*6,Y,  num%10);
}
...
void GpioInit_OLED(void)
{
    GPIO_InitTypeDef GPIO_InitStructure;

//RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOC,ENABLE);//enable gpioB clock
...
//	GPIO_Init(GPIOC,&GPIO_InitStructure);
    ...
    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOD,ENABLE);//enable gpioB clock
    GPIO_InitStructure.GPIO_Pin=GPIO_Pin_0|GPIO_Pin_1|GPIO_Pin_4|GPIO_Pin_3;
    GPIO_InitStructure.GPIO_Mode=GPIO_Mode_OUT;
    GPIO_InitStructure.GPIO_OType = GPIO_OType_PP;
    GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
...
//==============================================================
//???: void LCD_Rectangle(uint8 x1,uint8 y1,
